<template>
    <div class="w-full mx-auto">
        ...
        <div class="w-full relative rounded-b-md shadow-sm border border-gray-300 dark:border-gray-800 h-[500px] overflow-y-auto" >
            ...
            <div class="preview h-max min-h-full p-4 top-0 left-0 prose md:prose-md lg:prose-lg xl:prose-xl block max-w-none prose-indigo leading-6 dark:prose-invert dark:bg-[#1c1c1c]" v-html="rendered" v-else></div>
        </div>
    </div>
</template>
